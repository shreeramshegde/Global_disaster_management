export default function GlobeLegend() {
  const items = [
    { label: "Earthquake", color: "#ff2d55" },
    { label: "Wildfire (High intensity)", color: "#fb923c" },
    { label: "Flood (High rainfall risk)", color: "#38bdf8" },
    { label: "Conflict (High fatalities)", color: "#b91c1c" }
  ];

  return (
    <div className="rounded-lg border border-white/10 bg-slate-950/65 p-4 text-sm shadow-[0_0_35px_rgba(14,165,233,0.14)] backdrop-blur-xl">
